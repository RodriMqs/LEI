...
void mostrarElementoPilha (DadosPilha);

DadosPilha criarElementoPilha ();

// comparação de 2 elementos do tipo DadosPilha, segundo o campo numAluno (chave)
// devolve -1 se primeiro < segundo, 0 se iguais, 1 se primeiro > segundo
int compararElementosPilha (DadosPilha, DadosPilha);
...
int compararElementosP (DadosPilha X, DadosPilha Y)
{
